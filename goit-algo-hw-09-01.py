...
def find_coins_greedy(amount):
    """
    Повертає словник монет для видачі решти,
...
def find_min_coins(amount):
    ...
    для мінімізації кількості монет.
    """
...
def benchmark():
    """
    Порівнює продуктивність жадібного алгоритму
    та алгоритму динамічного програмування.
    """
    amount = 113
    runs = 10_000
